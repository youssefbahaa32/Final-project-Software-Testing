...
public class AdminDashboardPage {
    ...
    private By salesMenu = By.xpath("//a[contains(text(), 'Sales')]");
    private By ordersLink = By.xpath("//a[contains(text(), 'Orders')]");
    private By returnsLink = By.xpath("//a[contains(text(), 'Returns')]");
    ...
    public OrderListPage navigateToOrders() {
        clickMenuItem(salesMenu, ordersLink);
        return new OrderListPage(driver);
    }

    public ReturnListPage navigateToReturns() {
        clickMenuItem(salesMenu, returnsLink);
        return new ReturnListPage(driver);
    }
}

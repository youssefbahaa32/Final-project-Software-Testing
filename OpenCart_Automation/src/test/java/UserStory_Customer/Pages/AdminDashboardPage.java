...
public class AdminDashboardPage {
    ...
    public CustomerListPage navigateToCustomers() {
        clickMenuItem("Customers", "Customers");
        return new CustomerListPage(driver);
    }

    public CustomerGroupPage navigateToCustomerGroups() {
        clickMenuItem("Customers", "Customer Groups");
        return new CustomerGroupPage(driver);
    }
}

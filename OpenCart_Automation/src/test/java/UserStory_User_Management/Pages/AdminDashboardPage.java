...
public class AdminDashboardPage {
    ...
    public UserManagementPage navigateToUsers() {
        clickMenuItem("System", "Users");
        return new UserManagementPage(driver);
    }

    public UserManagementPage navigateToUserGroups() {
        clickMenuItem("System", "User Groups");
        return new UserManagementPage(driver);
    }

    public UserManagementPage navigateToAPI() {
        clickMenuItem("System", "API");
        return new UserManagementPage(driver);
    }
}
